...
def load_manuscript():
    ...
    for paragraph in paragraphs:
        test_paragraphs = current_page_paragraphs + [paragraph]
        ...
        if text_fits_page(test_text):
            ...
            current_page_paragraphs = [paragraph]
...
page_preview.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
page_preview.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
...
print("Event loop ended with:", exit_code)
